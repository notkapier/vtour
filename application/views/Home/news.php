  ...
  <section class="magazine-section my-5">
    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-12">
        ...
        <div class="single-news mb-4 col-md-12">
          ...
          <div class="news-data d-flex justify-content-between">
            <a href="#!" class="light-blue-text">
              <h6 class="font-weight-bold"><i class="fas fa-check pr-2"></i>Lorem ipsum</h6>
            </a>
          ...
          <p class="dark-grey-text">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
            ...
            dolor
            repellendus.<button class="btn btn-info btn-sm">Read more</button></p>
